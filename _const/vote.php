...
if($_POST['submit']){
	...
	if ($vote != 0) {
		$update_totalvotes = "UPDATE const_poll SET totalvotes = totalvotes + 1";
			$insert = mysql_query($update_totalvotes);
		$update_votes = "UPDATE const_options SET votes = votes + 1 WHERE id = $vote";
...
<div id="pagew">
		<form action="vote.php" method="post">
			<div class="poll"><?
			$getcurrent = mysql_query("select * from const_options ORDER by id");
