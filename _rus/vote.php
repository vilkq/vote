...
<div id="pagew">
		...
		<?	}	?>
			...
			<input type="submit" name="submit" value=" " style="background-image: url(/vote/files/button.png); width: 180px; height: 56px; color: #000; float: right; margin: 10px 135px 0 0;" />
		</form>
</div> <!-- pagew -->
...
$.ajax({
    type: "POST",
    url: "startstop.php",
    success: function(data){if (data == 0) {window.location.href = "index.php"}}
});
}, 2000);;
</script>
